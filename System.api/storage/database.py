...
SQLALCHEMY_DATABASE_URL_LOCAL = "postgresql://"+ POSTGRESDB.POSTGRES_USERNAME +":"+ POSTGRESDB.POSTGRES_PASSWORD +"@"+ POSTGRESDB.POSTGRES_HOST +"/" + POSTGRESDB.POSTGRES_SCHEMA
